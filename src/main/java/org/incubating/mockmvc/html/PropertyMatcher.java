...
public class PropertyMatcher<V, T> extends TypeSafeDiagnosingMatcher<V> {
    ...
    public PropertyMatcher(Consumer<Description> description, Function<V, T> extractor, Matcher<T> matcher) {
